...
$notify
<div id="wrapper">
<h1>NDS.OJ 十一学校的小破评测系统</h1>
<p class="small"><a href="/">TrageWeb</a> » $data.nav<a href="/user/change_theme?ref=$this.url" style="float: right;">⚉ 切换主题 ⚉</a></p>
<hr />
$data.main
<hr />
<p class="xsmall"><a onclick="alert('别点我！有意思吗？')">♥</a> Proudly powered by <a href="http://code.google.com/p/trage/">TrageWeb</a>. Made in Beijing National Day School.<button id="robot_button" onclick="robot_button();" style="float: right; margin-top: 5px;">他们有一个计划</button></p>
</div>
</body>
</html>
